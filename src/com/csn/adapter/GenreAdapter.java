...
public class GenreAdapter extends BaseAdapter {
	...
	public GenreAdapter(Context context, ArrayList<GenreEntity> listGenres) {
		super();
	...
	@Override
	public GenreEntity getItem(int position) {
		return listGenres.get(position);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		timeEntity = (GenreEntity) getItem(position);
