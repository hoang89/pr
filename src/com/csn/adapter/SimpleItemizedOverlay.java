...
public class SimpleItemizedOverlay extends BalloonItemizedOverlay<OverlayItem> {
	public interface OnTabOverlayItem {
...
//				Toast.LENGTH_LONG).show();
		if(overlayItem != null){
			overlayItem.onTab(index);
		}
		return false;
	}
	
	
	OnTabOverlayItem overlayItem;
	public void setTabOverlayItem(OnTabOverlayItem onTabOverlayItem) {
		this.overlayItem = onTabOverlayItem;
	}
}
